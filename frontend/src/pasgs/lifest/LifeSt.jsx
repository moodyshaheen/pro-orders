...
function LifeStNew() {
  ...
  // دمج معلومات المنتج مع حالة المفضلة وعدد الكمية
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const res = await axios.get(url + "/api/product/list?category=Jewelry");
  ...
  return (
    <div className="sectionWrapper">
      <h2 className="sectionTitle">Life Style</h2>
